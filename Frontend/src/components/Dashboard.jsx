    ...
    <div className="flex bg-gray-50 min-h-screen font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* 지출결의서/사용자관리 페이지에서는 필터 및 초기화면 미표시 */}
          {isUserManagement || isExpensePage ? (
              ...
              {!data && !loading ? (
                <div className="flex flex-col items-center justify-center py-24 px-4 text-center max-w-2xl mx-auto opacity-80 mt-12">
                  ...
                  <p className="text-lg text-gray-500 leading-relaxed font-medium">
                    상단의 <span className="text-blue-600 font-bold bg-blue-50 px-2 py-0.5 rounded-md">필터</span>에서 원하는 <span className="font-bold text-gray-700">년, 월, 주차</span>를 선택한 후 <br className="hidden sm:block" />
                    <span className="font-bold text-blue-600">"조회하기"</span> 버튼을 클릭하여 데이터를 확인해보세요.
                  </p>
                </div>
              ) : loading ? (
